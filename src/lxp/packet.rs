...
impl ReadInputs {
    ...
    pub fn to_input_all(&self) -> ReadInputAll {
        let ri1 = self.read_input_1.as_ref().unwrap();
        let ri2 = self.read_input_2.as_ref().unwrap();
        let ri3 = self.read_input_3.as_ref().unwrap();
