...
impl Config {
    pub fn all(
        ...
        let r = vec![
            ...
            Self::energy(inverter, mqtt_config, "e_pv_all", "PV Generation (All time)", 2)?,
            Self::energy(inverter, mqtt_config, "e_pv_all_1", "PV Generation (All time) (String 1)", 2)?,
            Self::energy(inverter, mqtt_config, "e_pv_all_2", "PV Generation (All time) (String 2)", 2)?,
            Self::energy(inverter, mqtt_config, "e_pv_all_3", "PV Generation (All time) (String 3)", 2)?,
            Self::energy(inverter, mqtt_config, "e_chg_all", "Battery Charge (All time)", 2)?,
            Self::energy(inverter, mqtt_config, "e_dischg_all", "Battery Discharge (All time)", 2)?,
            Self::energy(inverter, mqtt_config, "e_to_user_all", "Energy from Grid (All time)", 2)?,
            Self::energy(inverter, mqtt_config, "e_to_grid_all", "Energy to Grid (All time)", 2)?,
