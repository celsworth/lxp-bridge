...
impl Factory {
    ...
    pub fn read_input_all() -> lxp::packet::ReadInputAll {
        lxp::packet::ReadInputAll {
            ...
            t_bat: 0,
            runtime: 67589346,
            max_chg_curr: Some(150.0),
            max_dischg_curr: Some(150.0),
            charge_volt_ref: Some(53.2),
            dischg_cut_volt: Some(40.0),
            bat_status_0: Some(0),
            bat_status_1: Some(0),
            bat_status_2: Some(0),
            bat_status_3: Some(0),
            bat_status_4: Some(0),
            bat_status_5: Some(192),
            bat_status_6: Some(0),
            bat_status_7: Some(0),
            bat_status_8: Some(0),
            bat_status_9: Some(0),
            bat_status_inv: Some(3),
            bat_count: Some(6),
            bat_capacity: Some(0),
            bat_current: Some(0.0),
            bms_event_1: Some(1),
            bms_event_2: Some(2),
            max_cell_voltage: Some(0.0),
            min_cell_voltage: Some(0.0),
            max_cell_temp: Some(0.0),
            min_cell_temp: Some(0.0),
            bms_fw_update_state: Some(2),
